...
<p><strong>Book Translator</strong></p>
  ...
  <p>The tool processes plain text files using Google Translate and Ollama LLM models. It combines primary machine translation with literary editing for better results. Ideal for translators, publishers, authors, researchers, and content creators who need translations of large text documents.</p>
